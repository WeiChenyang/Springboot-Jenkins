...
public final class EncryptUtil {
    ...
    public static void main(String[] args) {
        String publicKey = "";
        Map<String, String> bean = new HashMap<>();
        bean.put("name", "test");
        bean.put("cnbmIntfCode", "demo01");
        bean.put("isAdmin", Boolean.toString(false));
        bean.put("t", Long.toString(System.currentTimeMillis()));
        System.out.println(EncryptUtil.buildRSAEncryptByPublicKey(JSON.toJSONString(bean), publicKey));
    }
